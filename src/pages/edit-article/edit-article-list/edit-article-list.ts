...
export default class EditArticleList implements OnInit {
  @HostBinding('class.EditArticleList') rootClass: boolean = true;
  @HostBinding('class.EditArticleList--edit-mode') editMode: boolean = false;
