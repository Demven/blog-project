...
export default class EditArticleMath implements OnInit {
  @HostBinding('class.EditArticleMath') rootClass: boolean = true;
  @HostBinding('class.EditArticleMath--edit-mode') editMode: boolean = false;
