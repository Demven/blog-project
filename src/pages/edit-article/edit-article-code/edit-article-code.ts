...
export default class EditArticleCode implements OnInit {
  @HostBinding('class.EditArticleCode') rootClass: boolean = true;
  @HostBinding('class.EditArticleCode--edit-mode') editMode: boolean = false;
  ...
  public selectedCodeTypeIndex: number = 0;
